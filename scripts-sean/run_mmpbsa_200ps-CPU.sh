...
##        MMPBSA for ligand1           ##
#########################################
mkdir chainsABC-lig1_200ps
cd chainsABC-lig1_200ps
...
$AMBERHOME/bin/MMPBSA.py -O -i $SCRIPTS/mmpbsa.200ps.in \
...
##        MMPBSA for ligand2           ##
#########################################
mkdir chainsABC-lig2_200ps
cd chainsABC-lig2_200ps
...
##        MMPBSA for ligand3           ##
#########################################
mkdir chainsABC-lig3_200ps
cd chainsABC-lig3_200ps
