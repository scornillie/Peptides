...
SANDEREXE=/projects/sciteam/gk4/amber-gnu/bin/pmemd.cuda
...
$SANDEREXE -O -i mini.in -o mini.out -p $TOP -c $CRD -ref $CRD -r mini.rst -x mini.trj -e mini.ene
sleep 10
$SANDEREXE -O -i heat.in -o heat.out -p $TOP -c mini.rst -ref mini.rst -r heat.rst -x heat.trj -e heat.ene
sleep 10
$SANDEREXE -O -i mini5.in -o mini5.out -p $TOP -c heat.rst -ref heat.rst -r mini5.rst -x mini5.trj -e mini5.ene
sleep 10
$SANDEREXE -O -i eq5.in -o eq5.out -p $TOP -c mini5.rst -ref mini5.rst -r eq5.rst -x eq5.trj -e eq5.ene
sleep 10
$SANDEREXE -O -i mini4.in -o mini4.out -p $TOP -c eq5.rst -ref eq5.rst -r mini4.rst -x mini4.trj -e mini4.ene
sleep 10
$SANDEREXE -O -i eq4.in -o eq4.out -p $TOP -c mini4.rst -ref mini4.rst -r eq4.rst -x eq4.trj -e eq4.ene
sleep 10
$SANDEREXE -O -i mini3.in -o mini3.out -p $TOP -c eq4.rst -ref eq4.rst -r mini3.rst -x mini3.trj -e mini3.ene
sleep 10
$SANDEREXE -O -i eq3.in -o eq3.out -p $TOP -c mini3.rst -ref mini3.rst -r eq3.rst -x eq3.trj -e eq3.ene
sleep 10
$SANDEREXE -O -i mini2.in -o mini2.out -p $TOP -c eq3.rst -ref eq3.rst -r mini2.rst -x mini2.trj -e mini2.ene
sleep 10
$SANDEREXE -O -i eq2.in -o eq2.out -p $TOP -c mini2.rst -ref mini2.rst -r eq2.rst -x eq2.trj -e eq2.ene
sleep 10
$SANDEREXE -O -i mini1.in -o mini1.out -p $TOP -c eq2.rst -ref eq2.rst -r mini1.rst -x mini1.trj -e mini1.ene
sleep 10
$SANDEREXE -O -i eq1.in -o eq1.out -p $TOP -c mini1.rst -ref mini1.rst -r eq1.rst -x eq1.trj -e eq1.ene
sleep 10
$SANDEREXE -O -i eq05.in -o eq05.out -p $TOP -c eq1.rst -ref eq1.rst -r  peptide.tip3p.rand.rst.000 -x eq05.trj -e q05.ene
sleep 10
