...
DB="/u/sciteam/sean/scratch/EBOLA_2017/TRANSFER/UNSAFE_ebola.db"
for exp in g;
do
...
$SCRIPTS/insert.py $DB $SIMID update mmgbsa_chainsABC_peptide1 $(awk 'FNR == 114 {print $3}' ./chainsABC-lig1/FINAL.dat)
$SCRIPTS/insert.py $DB $SIMID update mmpbsa_chainsABC_peptide1 $(awk 'FNR == 196 {print $3}' ./chainsABC-lig1/FINAL.dat)

$SCRIPTS/insert.py $DB $SIMID update mmgbsa_chainsABC_peptide2 $(awk 'FNR == 114 {print $3}' ./chainsABC-lig2/FINAL.dat)
$SCRIPTS/insert.py $DB $SIMID update mmpbsa_chainsABC_peptide2 $(awk 'FNR == 196 {print $3}' ./chainsABC-lig2/FINAL.dat)

$SCRIPTS/insert.py $DB $SIMID update mmgbsa_chainsABC_peptide3 $(awk 'FNR == 114 {print $3}' ./chainsABC-lig3/FINAL.dat)
$SCRIPTS/insert.py $DB $SIMID update mmpbsa_chainsABC_peptide3 $(awk 'FNR == 196 {print $3}' ./chainsABC-lig3/FINAL.dat)

$SCRIPTS/insert.py $DB $SIMID update mmgbsa_chainsABC_peptide123 $(awk 'FNR == 114 {s+=$3}END{print s/3}' ./chainsABC-lig1/FINAL.dat ./chainsABC-lig2/FINAL.dat ./chainsABC-lig3/FINAL.dat)
$SCRIPTS/insert.py $DB $SIMID update mmpbsa_chainsABC_peptide123 $(awk 'FNR == 196 {s+=$3}END{print s/3}' ./chainsABC-lig1/FINAL.dat ./chainsABC-lig2/FINAL.dat ./chainsABC-lig3/FINAL.dat)
